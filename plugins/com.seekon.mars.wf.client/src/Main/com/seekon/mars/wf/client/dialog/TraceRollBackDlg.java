...
import com.seekon.mars.wf.client.panel.TraceRollBackPanel;
import com.seekon.mars.wf.engine.model.runtime.TableData;
import com.seekon.mars.wf.model.BusinessType;

public class TraceRollBackDlg extends AbstractTraceActionDlg {

  public TraceRollBackDlg(Dialog owner, String title, boolean modal, 
  ...
  public TraceRollBackDlg(Dialog owner, String title, int treeType, 
    Map<String, String> sessionMap,TableData tableData,String compId, Long templateId, Long instanceId,
    String userId, Map<String,String> vMap,String  vDesc,
    int treeType0, BusinessType businessObj) {
  ...
  public TraceRollBackDlg(Frame owner, String title, boolean modal, 
    Map<String, String> sessionMap,TableData  tableData,String compId,Long templateId, Long instanceId,
    String userId, Map<String,String> vMap,String  vDesc,
    int treeType0, BusinessType businessObj) {
    super(owner, title, modal, sessionMap, tableData, compId, templateId, instanceId, userId, vMap, vDesc, treeType0, businessObj);
  ...
  public TraceRollBackDlg(Frame owner, String title, int treeType, 
    Map<String, String> sessionMap,TableData tableData,String compId,Long templateId, Long instanceId,
    String userId, Map<String,String> vMap,String  vDesc,
    int treeType0, BusinessType businessObj) {
    super(owner, title, treeType, sessionMap, tableData, compId,templateId, instanceId, userId, vMap, vDesc, treeType0, businessObj);
  ...
  public TraceRollBackDlg(Window owner, String title, 
    Map<String, String> sessionMap,TableData  tableData,String compId,Long templateId, Long instanceId, 
    String userId, Map<String,String> vMap,String  vDesc,
    int treeType0,BusinessType businessObj) {
  ...
  public void initOperationPanel() {
    this.operationPanel = new TraceRollBackPanel(self,sessionMap,tableData,compId,templateId,instanceId,curUserId,vMap,vDesc, treeType,
      this.businessType);
  }
...
//        TraceRollBackDlg dlg = new TraceRollBackDlg(frame, "流程跟踪", false, new Long(2023), new Long(9013),
