...
public class ToolBarButton extends JLabel {
  ...
  private static final Border EMPTY_BORDER = BorderFactory.createEmptyBorder(BORDER,
  ...
  private static final Border LINE_BORDER = BorderFactory.createCompoundBorder(
    BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(BORDER - 2,
      BORDER - 2, BORDER - 2, BORDER - 2), BorderFactory
      .createLineBorder(Color.gray)), BorderFactory.createEmptyBorder(1, 1, 1, 1));
