...
schema_name     : tmpName=ID {($tmpName.text.length()) <= 64}? {System.out.println("schema name = " + ($tmpName.text));};
table_name      : tmpName=ID {($tmpName.text.length()) <= 64}? {System.out.println("table name = " + ($tmpName.text));};
engine_name     : tmpName=ID {($tmpName.text.length()) <= 64}? {System.out.println("engine name = " + ($tmpName.text));};
column_name     : tmpName=ID {($tmpName.text.length()) <= 64}? {System.out.println("column name = " + ($tmpName.text));};
view_name     : tmpName=ID {($tmpName.text.length()) <= 64}? {System.out.println("view name = " + ($tmpName.text));};
parser_name     : tmpName=ID {($tmpName.text.length()) <= 64}? {System.out.println("parser name = " + ($tmpName.text));};
index_name      : tmpName=ID {($tmpName.text.length()) <= 64}? {System.out.println("index name = " + ($tmpName.text));};
partition_name      : tmpName=ID {($tmpName.text.length()) <= 64}? {System.out.println("partition name = " + ($tmpName.text));};
partition_logical_name    : tmpName=ID {($tmpName.text.length()) <= 64}? {System.out.println("partition_logical name = " + ($tmpName.text));};
constraint_symbol_name    : tmpName=ID {($tmpName.text.length()) <= 64}? {System.out.println("constraint_symbol name = " + ($tmpName.text));};
foreign_key_symbol_name   : tmpName=ID {($tmpName.text.length()) <= 64}? {System.out.println("foreign_key_symbol name = " + ($tmpName.text));};
collation_name      : tmpName=ID {($tmpName.text.length()) <= 64}? {System.out.println("collation name = " + ($tmpName.text));};
event_name      : tmpName=ID {($tmpName.text.length()) <= 64}? {System.out.println("event name = " + ($tmpName.text));};
user_name     : tmpName=ID {($tmpName.text.length()) <= 64}? {System.out.println("user name = " + ($tmpName.text));};
function_name     : tmpName=ID {($tmpName.text.length()) <= 64}? {System.out.println("function name = " + ($tmpName.text));};
procedure_name      : tmpName=ID {($tmpName.text.length()) <= 64}? {System.out.println("procedure name = " + ($tmpName.text));};
server_name     : tmpName=ID {($tmpName.text.length()) <= 64}? {System.out.println("server name = " + ($tmpName.text));};
wrapper_name      : tmpName=ID {($tmpName.text.length()) <= 64}? {System.out.println("wrapper name = " + ($tmpName.text));};
alias       : ( AS_SYM )? tmpName=ID {($tmpName.text.length()) <= 256}? {System.out.println("alias name = " + ($tmpName.text));};
