...
public class HttpServletRequestAdaptor extends HttpServletRequestWrapper {
	...
	public String getContextPath() {
		...
		////return super.getContextPath() + super.getServletPath();///2010-12-01
		String contextPath = this.servlet.getServletConfig().getInitParameter("Osgi-Context-Path");
		if (contextPath != null) {
	...
	public Object getAttribute(String attributeName) {
		if (isRequestDispatcherInclude) {
			if (attributeName.equals(HttpServletRequestAdaptor.INCLUDE_CONTEXT_PATH_ATTRIBUTE)) {
				...
				if (!pathInfo.contains(alias)) {////add 2010-12-14
					return pathInfo;
				}
	...
	public RequestDispatcher getRequestDispatcher(String arg0) {
		...
		return new RequestDispatcherAdaptor(super.getRequestDispatcher(path));
	}
