...
public class HttpServiceImpl implements HttpService, ExtendedHttpService {
	...
	public void registerFilter(String alias, String servletName, Filter filter, Dictionary initparams, HttpContext context) throws ServletException {
		checkShutdown();
		if (context == null) {
			context = createDefaultHttpContext();
		}
		proxy.registerFilter(alias, servletName, filter, initparams, context);
		filters.add(filter);
	}
